...
| Picture | ![IKEA E1812](https://psi-4ward.github.io/zigbee2mqtt-docs/images/devices/E1812.jpg) |
...
It may help to remove the battery for a few seconds and after that reconfigure it via [Configure](../guid/usage/mqtt_topics_and_message_structure.md#zigbee2mqttbridgeconfigure). Right before executing the Configure make sure to wake up the device by pressing a button on it.
