...
| Picture | ![Müller Licht MLI-404011](https://psi-4ward.github.io/zigbee2mqtt-docs/images/devices/MLI-404011.jpg) |
...
This means that you probably should carefully [define your groups id](../guid/usage/mqtt_topics_and_message_structure.html#zigbee2mqttbridgeconfigadd_group)  when creating them. When creating the binding you need to wake up the device. The most reliable way is to pull the battery, press any button to drain remaining power and insert it back right when sending the binding request to the remote. You do not need to bother with the default tint action groups (16388/16389/16390), they will be overwritten as soon as the binding was successful.
